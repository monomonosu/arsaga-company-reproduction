    ...
    return (
        <div>
            <div className="container" style={{ maxWidth: '1000px', textAlign: 'center', margin: '0 auto', padding: '80px 0' }}>
                <h1 style={{ color: '#e8374a', fontSize: '5.4rem', fontWeight: '500', letterSpacing: '3px', margin: '0', padding: '0' }}>COMPANY</h1>
                <p style={{ color: '#e8374a', fontSize: '1.6rem' }}>会社情報</p>
                ...
                <h4 style={{ fontSize: '3.6rem', fontWeight: '700', margin: '0 auto 40px' }}>
                    <span style={{ color: '#e8374a' }}>"人を作る"</span><span>だから</span><span style={{ color: '#e8374a' }}>”物を作れる”</span>
                </h4>
                <div className="inner" style={{ marginBottom: '80px' }}>
                    <p className="headline" style={{ color: '#e8374a', fontSize: '2rem', fontWeight: '700', marginBottom: '10px' }}>”人を作る”</p>
                ...
                <div className="inner">
                    <p className="headline" style={{ color: '#e8374a', fontSize: '2rem', fontWeight: '700', marginBottom: '10px' }}>自分自身の存在価値を疑う者たちをなくすため</p>
                    <p style={{ lineHeight: '36px' }}>
